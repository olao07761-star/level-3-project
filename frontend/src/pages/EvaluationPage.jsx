...
const EvaluationPage = () => {
    ...
    useEffect(() => {
        ...
        if (!userToken) {
            // Redirect to signup after a short delay to show loading state
            setLoading(false);
        ...
        <div className="evaluation-page">
            <div className="evaluation-container">
                {!isAuthenticated ? (
                    ...
                    <div className="evaluation-auth-prompt">
                        <h1>Create an Account to Continue</h1>
                        <p className="evaluation-auth-subtitle">
                            You need an account to get device Evaluations and complete swaps.
                        </p>
                        <button
                        ...
                        <p className="evaluation-auth-secondary">
                            Already have an account? <span
                                className="evaluation-auth-link"
                    ...
                    // Show evaluation form if authenticated
                    <>
